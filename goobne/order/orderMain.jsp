...
<script type="text/javascript">
	...
	function sendIt(){
		...
		f.action="<%=cp%>/goobnemall/order_ok.do";
		f.submit();
	}
...
<div id="contents">
	...
	<table border="0" width="1000" align="center" cellspacing="0">
		<tr height="50">
			...
			<td width="70%" align="left" style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;">
				<b><font size="3">&nbsp;&nbsp;${dtoProduct.productName }</font></b>
			</td>
			<td rowspan="2"  width="15%" align="center" style="border-bottom: solid;border-bottom-color: #BDBDBD;border-bottom-width: 1px;border-left: solid;border-left-color: #BDBDBD;border-left-width: 1px;">
				<font size="2"><b><fmt:formatNumber value="${dtoProduct.price*qty }" pattern=" #,### "/></b>원</font>
			</td>
		</tr>
		<tr height="50">
			<td width="70%" align="left" style="border-bottom: solid;border-bottom-color: #BDBDBD; border-bottom-width: 1px;">
				<font size="2">&nbsp;&nbsp;1개 가격 :&nbsp;&nbsp;&nbsp;<fmt:formatNumber value="${dtoProduct.price }" pattern=" #,### "/>원&nbsp;&nbsp;&nbsp;/
				&nbsp;&nbsp;&nbsp;수량 : &nbsp;&nbsp;&nbsp;${qty }개&nbsp;&nbsp;&nbsp;</font>
			</td>
		</tr>
	</table>
	...
	<div class="priceEnd">
		...
		<dd>
			...
			<fmt:formatNumber value="${dtoProduct.price*qty }" pattern=" #,###" /></strong>원</span>
		</dd></dl>
		...
		<dl class="total">
			...
			<dd><span class="price red"><strong class="pay_amt_text" id="last_pay_amt">
				<fmt:formatNumber value="${dtoProduct.price*qty+deliveryFee }" pattern=" #,###" /></strong>원</span></dd>
		</dl>
	...
	<div class="btnWrap cart" style="width:100%;margin:20px auto 0 !important;">
		<input type="hidden" value="${dtoProduct.productNum }" name="productNum"/>
		<input type="hidden" value="${qty }" name="qty"/>
		<input type="hidden" value="${dtoProduct.price*qty+deliveryFee }" name="totalCost"/> 
